...
class Tampilan1Java extends StatefulWidget {
  const Tampilan1Java({Key? key});

  @override
  State<Tampilan1Java> createState() => _Tampilan1JavaState();
}

class _Tampilan1JavaState extends State<Tampilan1Java> {
